...
[_BASE] = LAYOUT( \
    ...
    KC_GRAVE, KC_EQUAL, KC_NO,  KC_NO,                                              KC_NO,   KC_NO,  KC_LBRC, KC_RBRC, \
                                   LOWER, RAISE     ,             KC_SPC, KC_ENT,                                  \
...
[_LOWER] = LAYOUT(
    _______,_______,_______,_______,_______,KC_LBRC,            KC_RBRC, KC_P7, KC_P8,  KC_P9,  RESET,  KC_MUTE,   \
