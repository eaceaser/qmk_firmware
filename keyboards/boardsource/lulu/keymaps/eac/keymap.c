 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_LBRC,   KC_BSPC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_MINS,
...
[_LOWER] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______, QK_BOOT, _______, XXXXXXX, _______, _______, _______, _______, _______,
